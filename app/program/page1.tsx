    ...
    sections: [
      {
        ...
        rows: [
          ...
          [
            ...
            "Gideon Msambwa · Nasibu James\nGhai Edward · Patrick Manu\nCaleb Migombo\nKeynote: David Mpwani",
          ],
          ["09:30 – 09:35", "Service Promo", "—", "—"],
          ["09:35 – 09:45", "Health Break", "Networking & singing", "Entertainment Team"],
          ["09:45 – 10:30", "Presentation 1", "1 Billion Dashboard – Hope.cloud\nHow to reach audience with proper tools and measures", "Felipe Careca"],
          ["10:30 – 11:15", "Presentation 2", "—", "Ramiro Quero"],
          ["11:15 – 11:20", "Special Prayers", "Praying for Global Church Mission Initiatives", "Jonas Singo"],
          ["11:20 – 11:45", "Collection of Ideas, Suggestions & Questions", "What should communication experts do to facilitate and improve church operations\n+ Special Music Item", "Moderators\nMusic Band & The Sacred"],
          ["11:45 – 11:50", "Special Promo", "—", "Exhibition Committee"],
          ["11:50 – 12:50", "Video Reports & Project Slams", "Conference & Fields Communication Reports\nInnovative technologies for Mission and Church Operations", "Communication Directors\nContent & Creativity Committee and Judges"],
          ["12:50 – 14:00", "Lunch Break", "Fellowship and refreshments", "All"],
          ["14:00 – 15:20", "Open Discussion (Session A)", "OneVoice27 Initiative – Hope Channel\nDigital Shepherding: Engaging Your Flock Online", "Sam Neves"],
          ["15:20 – 15:30", "Break", "—", "—"],
          [
            "15:30 – 16:30",
            "Workshops (Session B)",
          ...
          ["16:30 – 17:00", "Day Reflection", "Conference/Field officers share key takeaways of the day", "Lengai Ngaleson · Reuben Mbonea\nKelvin Mavanza · Justine Mbwana"],
          ["17:00 – 18:30", "Sports Icebreaker", "Leaders' Football Match: NTUC vs STU\nNTUC Pastors vs STU Pastors", "—"],
    ...
    sections: [
      {
        ...
        rows: [
          ...
          ["11:05 – 11:55", "Presentation 6", "Hope Channel's Hope.cloud platform – celebrating 5 years of Jetstream", "Felipe Careca"],
          ["11:55 – 12:25", "Adventist World Radio Presentation", "Reaching the Unreached Through Radio & Digital Integration", "Immanuel Ogwal"],
          ["12:25 – 12:30", "Promo", "—", "Exhibition Committee"],
          ["12:30 – 12:50", "Video Reports & Project Slams", "Conference & Fields Communication Reports\nInnovative technologies for Mission and Church Operations", "Communication Directors\nContent & Creativity Committee and Judges"],
          ["12:50 – 14:00", "Lunch Break", "Fellowship and refreshments", "All"],
          [
            "14:00 – 15:20",
          ...
          ["16:30 – 17:00", "Day Reflection", "Daily highlights and lessons learned", "Clevant Otieno · Grayson Nashumba · Kenedy Warumbe · Abby Katete · Pascal Gissa · Joshua Mbwambo · Methuselah Masunga · Lupakisyo Mwakasweswe"],
    ...
    sections: [
      {
        ...
        rows: [
          ...
          ["12:00 – 12:30", "GAiN Grand Reflection", "GAiN 2026 Resolutions", "Shukrani Mutaki · Haruni Kuyenga · Leopold Mao · Elitabu Kajiru · Benjamini Ngalama · Richard Mashauri · Meshack Mahende"],
    ...
    sections: [
      {
        ...
        rows: [
          ...
          ["09:45 – 10:30", "Bible Study", "Interactive Bible Study: Theology of Communication in a Digital Age", "Alyssa Truman"],
          ...
          ["14:00 – 17:00", "Closing Ceremony & Awards", "GAiN Tanzania Music Concert & Awards Ceremony", "Mathias Mavanza"],
          ["17:00 onwards", "Fellowship & Final Networking", "Farewells, departures, and Dinner (Dinner starts at 18:00)", "All"],
        ],
      },
    ],
  },
...
const COL_WIDTH = ["w-[130px]", "w-[180px]", "", "w-[220px]"] as const;

function Badge({ children }: { children: React.ReactNode }) {
  return (
    <span className="inline-block text-[10px] font-semibold tracking-widest uppercase bg-red-100 text-red-700 px-2 py-0.5 rounded-full">
      {children}
    </span>
  );
}
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="bg-red-700 text-white">
        <div className="max-w-6xl mx-auto px-6 py-12 md:py-16">
          ...
          <p className="text-red-200 text-sm mt-3">
            Tentative Program &nbsp;·&nbsp; March 31 – April 4, 2026
          </p>
        </div>
      </div>
        ...
        <div className="flex gap-2 overflow-x-auto pb-1 mb-8 scrollbar-none">
          {DAYS.map((d, i) => (
            <button
              key={i}
              onClick={() => setActive(i)}
              className={`flex-shrink-0 flex flex-col items-center px-5 py-3 rounded-xl border transition-all text-sm font-semibold ${
                active === i
                  ...
                  <table className="w-full text-sm" style={{ minWidth: 640 }}>
                      ...
                      <tr className="bg-gray-950 text-white">
                        {section.cols.map((col, ci) =>
                          col ? (
                            <th
                              key={ci}
                              className={`px-4 py-3 text-left text-[11px] font-semibold tracking-widest uppercase ${COL_WIDTH[ci]}`}
                            >
                              {col}
                            </th>
                          ) : (
                    ...
                    <tbody>
                      {section.rows.map((row, rIdx) => (
                        <tr
                          key={rIdx}
                          className={`border-t border-gray-100 align-top transition-colors hover:bg-red-50/60 ${
                            rIdx % 2 !== 0 ? "bg-gray-50/60" : "bg-white"
                          }`}
                        >
                          {/* Time */}
                          <td className="px-4 py-3 font-semibold text-red-700 whitespace-nowrap text-[12px]">
                            {row[0]}
                          </td>
                          {/* Activity */}
                          ...
                          {/* Presenter / Location */}
                          {section.cols[3] ? (
                            <td className="px-4 py-3 text-gray-400 whitespace-pre-line text-[12px] leading-relaxed">
                              {row[3] || "—"}
                            </td>
                          ) : null}
                        </tr>
      ...
      <div className="border-t border-gray-100 mt-4 py-6 text-center text-xs text-gray-400 tracking-wide">
        GAiN Tanzania 2026 &nbsp;·&nbsp; Tentative Program &nbsp;·&nbsp; Subject to change
      </div>
    </main>
  );
}