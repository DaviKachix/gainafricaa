    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="text-center">
          ...
          >
            GAiN Tanzania will feature Church leaders, media and communication strategists,
            and digital mission pioneers shaping the future of our mission aligned with Technology.
          </motion.p>
